...
namespace QuoteSnap.Infrastructure.Migrations
{
    ...
    [Migration("20260920234709_AddSubscriptionEmailToken")]
    partial class AddSubscriptionEmailToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuoteSnap.Domain.Entities.DocumentDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BusinessId", "DocumentType", "DocumentId");

                    b.ToTable("DocumentDeliveries", (string)null);
                });

            modelBuilder.Entity("QuoteSnap.Domain.Entities.EmailConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuoteSnap.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.Property<string>("ExternalSubscriptionEmailToken")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("QuoteSnap.Domain.Entities.SubscriptionPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuoteSnap.Domain.Entities.SubscriptionPayment", b =>
                {
                    ...
                    b.HasOne("QuoteSnap.Domain.Entities.Subscription", "Subscription")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("QuoteSnap.Domain.Entities.Business", b =>
                {
                    ...
                    b.Navigation("DocumentDeliveries");
